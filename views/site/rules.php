...
<div class="site-about">
    ...
    <div class="d-inline-block mt-3">
        ...
        <ul>
            ...
            <li>Если пользователь попытается оставить вторую реакцию на тот же пост, предыдущая реакция должна быть
                заменена на новую.
            </li>
            <li>Если пользователь повторно выбирает реакцию, которую он уже оставил ранее, данная реакция должна быть
                удалена.
            </li>
        </ul>
    </div>
